...
use EolabsIo\AmazonMws\Database\Factories\AffordabilityExpenseReversalEventFactory;

class AffordabilityExpenseReversalEvent extends AmazonMwsModel
{
    ...
    {
        return AffordabilityExpenseReversalEventFactory::new();
    }
}
