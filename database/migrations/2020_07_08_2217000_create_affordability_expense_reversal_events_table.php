...
class CreateAffordabilityExpenseReversalEventsTable extends AmazonMwsMigration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('affordability_expense_reversal_events', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('affordability_expense_reversal_events');
    }
}
